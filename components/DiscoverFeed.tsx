...
const MOCK_PROFILES: MatchProfile[] = [
  {
    ...
    age: 28,
    gender: 'Female',
    bio: "Artist by day, gamer by night. Looking for player 2.",
    matchPercentage: 94,
    imageUrl: 'https://picsum.photos/400/600?random=1',
    interests: ['Art', 'Gaming', 'Coffee'],
  ...
  },
  {
    ...
    age: 31,
    gender: 'Male',
    bio: "Tech founder. I love hiking and everything outdoors. Let's go on an adventure.",
    matchPercentage: 88,
    imageUrl: 'https://picsum.photos/400/600?random=2',
    interests: ['Hiking', 'Startups', 'Dogs'],
  ...
  },
  {
    ...
    age: 26,
    gender: 'Female',
    bio: "PhD student in physics. I can explain how the universe works, but I can't explain why I'm still single.",
    matchPercentage: 91,
    imageUrl: 'https://picsum.photos/400/600?random=3',
    interests: ['Physics', 'Wine', 'Jazz'],
    politicalView: 'Liberal',
    wantsChildren: 'No',
    hasChildren: false
  },
  {
    ...
    age: 34,
    gender: 'Male',
    bio: "Chef who loves to travel. I'll cook you the best meal of your life if you plan the itinerary.",
    matchPercentage: 85,
  ...
  },
  {
    ...
    age: 24,
    gender: 'Female',
    bio: "Yoga instructor and plant mom. Searching for good vibes and deep conversations.",
    matchPercentage: 97,
  ...
  },
  {
    ...
    age: 29,
    gender: 'Male',
    bio: "Architect. I build things for a living. Looking to build a relationship next.",
    matchPercentage: 82,
    imageUrl: 'https://picsum.photos/400/600?random=6',
    interests: ['Architecture', 'Design', 'Running'],
    politicalView: 'Moderate',
    wantsChildren: 'Maybe',
    hasChildren: false
  },
  {
    ...
    age: 22,
    gender: 'Female',
    bio: "Student and part-time barista. I make great latte art and bad puns.",
    matchPercentage: 78,
  ...
  },
  {
    ...
    age: 38,
    gender: 'Male',
    bio: "Conservative values, looking for a serious relationship leading to marriage.",
    matchPercentage: 70,
    imageUrl: 'https://picsum.photos/400/600?random=8',
    interests: ['History', 'Politics', 'Golf'],
                  ...
                  <div className="flex flex-col gap-1">
                    {[
                      ...
                      <button
                        ...
                        className={`py-1.5 px-3 rounded-md text-xs font-semibold transition-all text-left ${
                          hasChildrenFilter === opt.value
...
const DiscoverFeed: React.FC<DiscoverFeedProps> = ({ userProfile }) => {
  ...
  const [profiles, setProfiles] = useState(filterProfiles());
  ...
  const resetFilters = () => {
    ...
    const resetFiltered = MOCK_PROFILES.filter(p => 
